...
\begin{table}[H]
\centering
\caption{小组成员分工及贡献度（基础为100\%）}
\label{tab:team-contribution}
\begin{tabular}{lcc}
\toprule
\textbf{姓名} & \textbf{主要分工} & \textbf{贡献度} \\
\midrule
俞烨 & 项目总体设计、制定实验方案、统筹论文撰写、代码设计与调参 & 160\% \\
黄绍华 & MOFA模型实现、多组学融合算法实现、结果分析与可视化 & 110\% \\
张璟文 & Stacking集成方法实现、交叉验证框架设计、基模型选择 & 110\% \\
张鸿榜 & 统计分析方法设计、显著性检验实现、图表制作与美化 & 110\% \\
吴飞龙 & 文档格式统一、代码整理与注释、参考文献整理 & 80\% \\
张天硕 & 数据下载与初步整理、特征工程辅助 & 65\% \\
李泽 & 实验结果复核、数据验证、辅助文档整理 & 65\% \\
\bottomrule
\end{tabular}
\end{table}
