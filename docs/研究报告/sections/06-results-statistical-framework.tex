...
本文在主结果中采用重复分层交叉验证作为统一评估口径。主实验统一使用 5 折 10 次重复，共 $n=50$ 个测试折，部分敏感性分析实验因配置差异使用 15、25、30 或 75 个测试折。所有结果均报告均值、标准差与 95\% 置信区间，以降低单次切分带来的偶然性，使不同方法的比较建立在更稳定的统计基础上。
