...
% 图表类型: 分组柱状图 + 误差线
% 数据来源: 实验日志汇总文件中 accuracy_mean, accuracy_ci95_low, accuracy_ci95_high 字段
...
类型: 分组柱状图 + 误差线\\
数据源: 实验日志汇总文件 (accuracy\_mean, accuracy\_ci95\_low/high)\\
...
类型: 箱线图 + 散点抖动\\
数据源: 各实验日志文件 (fold-level accuracy)\\
